...
import 'package:online_doctor/firestore-data/userDetails.dart';
...
class _UserProfileState extends State<AdminProfile> {
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        return Container(
          ...
          child: Text(
            userData!['Special'] == null ? "No Special" : userData['Special'],
            style: const TextStyle(
              fontSize: 16,
